...
public class AppointmentDummy implements Parcelable {
    ...
    public AppointmentDummy(int id, String name, String status, Calendar dateTime, String clinic, String country) {
        this.id = id;
        this.name = name;
        this.status = status;
    ...
    public AppointmentDummy(Parcel in){
        readFromParcel(in);
    }
    ...
    public static final Creator CREATOR = new Creator() {
        public AppointmentDummy createFromParcel(Parcel in) { return new AppointmentDummy(in);
        }
        public AppointmentDummy[] newArray(int size) { return new AppointmentDummy[size]; }
    };
